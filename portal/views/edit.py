    ...
    if request.user.has_perm('account.CRUD'):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                prescriber.fname=form.cleaned_data.get('firstname')
                prescriber.lname=form.cleaned_data.get('lastname')
                prescriber.gender=form.cleaned_data.get('gender')
                prescriber.state=form.cleaned_data.get('state')
                prescriber.credentials=form.cleaned_data.get('credentials')
                prescriber.specialty=form.cleaned_data.get('specialty')
