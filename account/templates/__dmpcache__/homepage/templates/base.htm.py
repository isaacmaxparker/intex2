...
_magic_number = 10
_modified_time = 1554770337.679644
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        if request.user.is_authenticated:
            ...
            if user.groups.filter(name='HHA').exists():
